...
const MessagesControl = (props) => {
  ...
  async function onCreateUserUsingId(e){
    ...
    const response = await fetch('https://eli-fr.herokuapp.com/conversation/verify', requestOptions)
  ...
  const holdConversation = async()=>{
    ...
    let sort =sortNames(username, receiver)
      ...
      console.log(requestOptions)
      const response = await fetch('https://eli-fr.herokuapp.com/hold-conversation', requestOptions)
      const res = await response.json()
